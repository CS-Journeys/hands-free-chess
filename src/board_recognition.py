...
def get_board_coords():
    ...
    while i < round((3 / 4) * ss_height) and not col_coords_are_found:
        ...
        for cluster in cpcs_length_clusters:
            ...
            if checker_pattern_start_index != -1:
                ...
                actual_first_square_length = cluster[
                                                 checker_pattern_start_index + 1].start_pixel - first_cpcs.start_pixel
    ...
    if col_coords_are_found and row_coords_are_found:
        ...
        fullsize_row_coords = [(scaled_row_coord * SCREEN_HEIGHT) / SCALED_HEIGHT for scaled_row_coord in
                               scaled_row_coords]
        fullsize_col_coords = [(scaled_col_coord * SCREEN_HEIGHT) / SCALED_HEIGHT for scaled_col_coord in
                               scaled_col_coords]
